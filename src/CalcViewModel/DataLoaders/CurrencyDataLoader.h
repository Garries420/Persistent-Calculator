...
namespace CalculatorApp
{
    ...
    public
        ...
        namespace CurrencyDataLoaderConstants
        {
            ...
            extern Platform::StringReference AutoRefreshAttemptTimestampKey;
            ...
            extern long long AutoRefreshInterval;
        }
        ...
        public:
            ...
            static bool ShouldAutomaticallyRefresh(
                Windows::Foundation::DateTime cacheTimestamp,
                Windows::Foundation::DateTime currentTime);
        ...
        private:
            ...
            bool m_skipAutomaticWebAttempt;
        };
    }
}
