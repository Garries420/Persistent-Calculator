...
public
    ref struct CalcManagerSnapshot sealed
    {
        ...
        property Windows::Foundation::Collections::IVector<CalcManagerHistoryItem ^> ^ StandardHistoryItems; // optional
        property Windows::Foundation::Collections::IVector<CalcManagerHistoryItem ^> ^ ScientificHistoryItems; // optional
