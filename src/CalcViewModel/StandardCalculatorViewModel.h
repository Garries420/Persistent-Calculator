...
#define ASCII_0 48
    ...
    public
        ...
        public:
            ...
            // Persistent Calculator keeps a user-visible calculation session that
            // survives Microsoft's normal expression reset after '='.  The managed
            // shell records this value continuously in Documents history.
            OBSERVABLE_PROPERTY_R(Platform::String ^, PersistentExpression);
            OBSERVABLE_PROPERTY_R(int, PersistentHistorySessionId);
            property Platform::String ^ PersistentHistoryValue
            {
                Platform::String ^ get()
                {
                    return GetRawDisplayValue();
                }
            }
            property CalculatorApp::ViewModel::Common::NumbersAndOperatorsEnum PersistentHistoryAngleType
            {
                CalculatorApp::ViewModel::Common::NumbersAndOperatorsEnum get()
                {
            ...
            property CalculatorApp::ViewModel::Snapshot::CalcManagerSnapshot ^ HistorySnapshot {
                CalculatorApp::ViewModel::Snapshot::CalcManagerSnapshot ^ get();
            };

            void RestoreHistory(CalculatorApp::ViewModel::Snapshot::CalcManagerSnapshot ^ snapshot);
        ...
        public:
            ...
            void RecallPersistentHistory(Platform::String ^ expression, Platform::String ^ result);
        ...
        private:
            ...
            void UpdatePersistentExpression(
                CalculatorApp::ViewModel::Common::NumbersAndOperatorsEnum command,
                Platform::String ^ previousDisplayValue,
                std::wstring const& previousEngineExpression);
            void ResetPersistentExpressionSession();
            std::wstring GetExpressionText() const;
            static bool IsPersistentBinaryCommand(CalculatorApp::ViewModel::Common::NumbersAndOperatorsEnum command);
            static std::wstring GetPersistentBinaryOperatorSymbol(CalculatorApp::ViewModel::Common::NumbersAndOperatorsEnum command);
            ...
            std::wstring m_persistentExpressionPrefix;
            std::wstring m_persistentCurrentOperationPrefix;
            bool m_persistentLastCommandWasEquals;
