...
namespace CalculatorApp
{
    namespace ViewModel
    {
        ...
        public:
            ...
            property Platform::String ^ PersistentHistorySourceValue
            {
                Platform::String ^ get()
                {
                    return ref new Platform::String(m_valueFromUnlocalized.c_str());
                }
            }

            void RestorePersistentHistoryValue(Platform::String ^ unlocalizedValue);
