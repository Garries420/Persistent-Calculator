...
namespace CalculatorUITests
{
    ...
    public class CurrencyConverterFunctionalTests
    {
        ...
        /// </summary>
        [TestMethod]
        [Ignore("Microsoft-only synthetic fractional-digit metadata is not provided by Frankfurter v2.")]
        [Priority(0)]
        ...
        /// <summary>
        /// Verifies that a real currency supplied by Frankfurter can be selected and
        /// still uses its ISO minor-unit precision in the calculator input format.
        /// </summary>
        [TestMethod]
        [Priority(0)]
        public void MouseInput_SelectFrankfurterCurrencyAndRespectIsoMinorUnits()
        {
            var currency = (string)TestContext.Properties["FrankfurterCurrency"];

            page.SelectUnits1(currency);
            Assert.AreEqual(currency.Replace(" - ", " "), page.UnitConverterOperators.Units1.Text);

            page.UnitConverterOperators.NumberPad.Num2Button.Click();
            Assert.AreEqual("2", page.UnitConverterResults.GetCalculationResult1Text());
            page.UnitConverterOperators.NumberPad.DecimalButton.Click();
            Assert.AreEqual("2.000", page.UnitConverterResults.GetCalculationResult1Text());
            page.UnitConverterOperators.NumberPad.Num4Button.Click();
            Assert.AreEqual("2.400", page.UnitConverterResults.GetCalculationResult1Text());
            page.UnitConverterOperators.NumberPad.Num3Button.Click();
            Assert.AreEqual("2.430", page.UnitConverterResults.GetCalculationResult1Text());
            page.UnitConverterOperators.NumberPad.Num5Button.Click();
            Assert.AreEqual("2.435", page.UnitConverterResults.GetCalculationResult1Text());
            page.UnitConverterOperators.NumberPad.Num6Button.Click();
            Assert.AreEqual("2.435", page.UnitConverterResults.GetCalculationResult1Text());
