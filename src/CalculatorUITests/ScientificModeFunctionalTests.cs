...
namespace CalculatorUITests
{
    ...
    public class ScientificModeFunctionalTests
    {
        ...
        public void SmokeTest_CloseParenthesis()
        {
            ...
            Assert.AreEqual("(8)\x00D72=", page.CalculatorResults.GetCalculatorExpressionText().Replace(" ", string.Empty));
            ...
            Assert.IsTrue(historyItems0[0].GetExpression().Replace(" ", string.Empty).Equals("(8)\x00D72=", StringComparison.InvariantCultureIgnoreCase));
            page.HistoryPanel.CloseHistoryPanel();

            /*
             * TEST #2
             */
            // Each block is a separate calculation. Persistent Calculator keeps
            // a draft alive until C/Escape, so make that boundary explicit.
            ...
            Assert.AreEqual("(7\x00D72)\x00D72=", page.CalculatorResults.GetCalculatorExpressionText().Replace(" ", string.Empty));
            ...
            Assert.IsTrue(historyItems1[0].GetExpression().Replace(" ", string.Empty).Equals("(7\x00D72)\x00D72=", StringComparison.InvariantCultureIgnoreCase));
            page.HistoryPanel.CloseHistoryPanel();
            ...
            Assert.AreEqual("(8)\x00D70.5=", page.CalculatorResults.GetCalculatorExpressionText().Replace(" ", string.Empty));
            ...
            Assert.IsTrue(historyItems2[0].GetExpression().Replace(" ", string.Empty).Equals("(8)\x00D70.5=", StringComparison.InvariantCultureIgnoreCase));
            page.HistoryPanel.CloseHistoryPanel();
            ...
            Assert.IsTrue(historyItems3[0].GetExpression().Replace(" ", string.Empty).Equals("(8)\x00D70.5=", StringComparison.InvariantCultureIgnoreCase));
            page.HistoryPanel.CloseHistoryPanel();
        }
