...
namespace CalculatorUITests
{
    ...
    public class StandardModeFunctionalTests
    {
        ...
        public void MouseInput_AddSubtractClearClearEntryTwoThree()
        {
            ...
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("2 + 2")); //verifies cohesive chain before -
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("4"));
        ...
        public void MouseInput_MultiplyDivideEqualFourFiveSix()
        {
            ...
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("4 × 5")); //verifies cohesive chain before ÷
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("20"));
            ...
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("20 ÷ 6")); //verifies = button
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().EndsWith("=", StringComparison.Ordinal));
        }
        ...
        public void MouseInput_InvertSquaredSevenEightNine()
        {
            ...
            Assert.AreEqual("sqr(9)", page.CalculatorResults.GetCalculatorExpressionText()); //verifies the visible persistent squared expression
        }
        ...
        public void MouseInput_HistoryButtons()
        {
            ...
            Assert.AreEqual(1, historyFlyoutItems.Count);
            ...
            Assert.IsTrue(historyFlyoutItems[0].GetExpression().Contains("4")); //verifies cohesive History button entry
            Assert.IsTrue(historyFlyoutItems[0].GetExpression().Contains("20"));
            Assert.IsTrue(historyFlyoutItems[0].GetExpression().EndsWith("=", StringComparison.Ordinal));
        ...
        public void KeyboardInput_AddSubtractClearClearEntryTwoThree()
        {
            ...
            Assert.AreEqual("4", page.CalculatorResults.GetCalculatorResultText()); //verifies addition
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("2 + 2")); //verifies cohesive chain before subtraction
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("4"));
        ...
        public void KeyboardInput_MultiplyDivideEqualFourFiveSix()
        {
            ...
            Assert.AreEqual("20", page.CalculatorResults.GetCalculatorResultText()); //verifies multiplication
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("4 × 5")); //verifies cohesive chain before divide
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("20"));
            ...
            Assert.AreEqual("3.333333333333333", page.CalculatorResults.GetCalculatorResultText()); //verifies division
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("20 ÷ 6")); //verifies equal key
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().EndsWith("=", StringComparison.Ordinal));
        }
        ...
        public void KeyboardInput_HistoryHotkeys()
        {
            ...
            Assert.IsTrue(historyExpression0.Contains("4"));
            Assert.IsTrue(historyExpression0.Contains("20"));
            Assert.IsTrue(historyExpression0.EndsWith("=", StringComparison.Ordinal));
            page.HistoryPanel.ResizeWindowToDisplayHistoryLabel();
            var historyItems = page.HistoryPanel.GetAllHistoryListViewItems();
            Assert.AreEqual(1, historyItems.Count);
        ...
        public void MixedInput_Operators_Equal()
        {
            ...
            Assert.IsTrue(historyItems[0].GetExpression().Contains("0"));
            page.HistoryPanel.CloseHistoryPanel();
            CalculatorApp.Window.SendKeys(Keys.Escape);
        }
        ...
        public void MixedInput_Operators_ClearEntryClear()
        {
            ...
            page.StandardOperators.ClearEntryButton.Click();
            Assert.AreEqual("0", page.CalculatorResults.GetCalculatorResultText());
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("3 + 9"));
            Assert.IsTrue(page.CalculatorResults.GetCalculatorExpressionText().Contains("12"));
        ...
        #region Compact Overlay removal tests

        [TestMethod]
        [Priority(0)]
        public void CompactOverlay_ButtonIsNotExposed()
        {
