...
namespace CalculatorUnitTests
{
    ...
    private:
        void ValidateNavCategory(IVector<NavCategory ^> ^ categories, unsigned int index, ViewMode expectedMode)
        {
            ...
            VERIFY_IS_TRUE(category->IsEnabled);
        }
    };
    ...
    public:
        TEST_METHOD(Serialize)
        {
            ...
            VERIFY_ARE_EQUAL(-1, NavCategoryStates::Serialize(ViewMode::Graphing));
        ...
        TEST_METHOD(IsValidViewMode_AllValid)
        {
            ...
            VERIFY_IS_FALSE(NavCategoryStates::IsValidViewMode(ViewMode::Graphing));
        ...
        TEST_METHOD(GetFriendlyName)
        {
            ...
            VERIFY_ARE_EQUAL(StringReference(L"None"), NavCategoryStates::GetFriendlyName(ViewMode::Graphing));
        ...
        TEST_METHOD(GetGroupType)
        {
            ...
            VERIFY_ARE_EQUAL(CategoryGroupType::None, NavCategoryStates::GetGroupType(ViewMode::Graphing));
        ...
        TEST_METHOD(GetIndexInGroup)
        {
            ...
            VERIFY_ARE_EQUAL(-1, NavCategoryStates::GetIndexInGroup(ViewMode::Graphing, CategoryGroupType::Calculator));
        ...
        TEST_METHOD(GetViewModeForVirtualKey)
        {
            ...
            VERIFY_ARE_EQUAL(ViewMode::None, NavCategoryStates::GetViewModeForVirtualKey(MyVirtualKey::Number3));
        ...
        TEST_METHOD(IsViewModeEnabled_ShouldBeTrue_ForAvailableModes)
        {
        ...
        TEST_METHOD(GraphingMode_ShouldRemainUnavailable)
        {
            NavCategoryStates::SetCurrentUser("null-user");
            VERIFY_IS_FALSE(NavCategoryStates::IsViewModeEnabled(ViewMode::Graphing));
            VERIFY_ARE_EQUAL(ViewMode::None, NavCategoryStates::Deserialize(ref new Box<int>(17)));
        }

    private:
        const static inline std::vector<ViewMode> _orderedModes {
            ViewMode::Standard, ViewMode::Scientific, ViewMode::Programmer, ViewMode::Date,     ViewMode::Currency, ViewMode::Volume,
