...
int main(void) {
    ...
    expect_true("converter search matches contained text",
                extras_unit_matches_search(MODE_LENGTH, 10, L"tic"));
    expect_true("converter search removes non-matches",
                !extras_unit_matches_search(MODE_LENGTH, 0, L"tic"));
    expect_true("converter search matches symbols",
                extras_unit_matches_search(MODE_DATA, 7, L"gib"));
